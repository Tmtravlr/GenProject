...
public final class GenesisRecipes
{
	...
	public static void addRecipes()
	{
		...
		GameRegistry.addShapelessRecipe(new ItemStack(GenesisItems.flint_and_marcasite), GenesisItems.nodules.getStack(EnumNodule.MARCASITE), GenesisItems.tools.getStack(ToolItems.PEBBLE, EnumToolMaterial.BROWN_FLINT));
