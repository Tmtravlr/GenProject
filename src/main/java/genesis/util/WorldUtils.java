...
public class WorldUtils
{
	 ...
	 * @param dNegX
	 *            The distance along the X axis in the negative direction.
	 * @param dPosX
	 *            The distance along the X axis in the positive direction.
	 * @param dNegZ
	 *            The distance along the Z axis in the negative direction.
	 * @param dPosZ
	 *            The distance along the Z axis in the positive direction.
	 * @param dNegY
	 *            The distance along the Y axis in the negative direction.
	 * @param dPosY
	 *            The distance along the Y axis in the positive direction.
	 ...
	 *            The position to start from.
	 * @param dX
	 *            The distance along the X axis to check from the starting block position.
	 * @param dZ
	 *            The distance along the Z axis to check from the starting block position.
	 * @param dY
