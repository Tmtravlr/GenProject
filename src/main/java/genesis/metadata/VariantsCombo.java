...
public class VariantsCombo<V extends IMetadata, B extends Block, I extends Item> extends VariantsOfTypesCombo<ObjectType<B, I>, V>
{
	 ...
	 *
	 * @param objectType
	 *            The sole ObjectType that this VariantsCombo will use.
	 * @param itemClass
	 *            the Item class to initialize for each variant.
	 */
	 ...
	 *
	 * @param name
	 *            The name to attach to each variant (i.e. "ore", to result in "variant_ore").
	 * @param unlocalizedName
	 *            The unlocalized name for each variant.
	 * @param blockClass
	 *            The Block class to initialize for each variant.
	 * @param itemClass
	 *            the Item class to initialize for each variant.
	 */
	...
	/**
	 * Constructs a BlocksAndItemsWithVariantsOfTypes with one ObjectType for simple one-type combos.<br>
	 * <br>
	 *
