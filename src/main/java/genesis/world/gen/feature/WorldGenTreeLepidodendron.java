...
public class WorldGenTreeLepidodendron extends WorldGenTreeBase
{
	...
	public boolean generate(World worldIn, Random rand, BlockPos pos)
	{
		...
		boolean check = false; (worldIn.getBlockState(pos).getBlock().isAir(worldIn, pos) || worldIn.getBlockState(pos).getBlock().isLeaves(worldIn, pos)) && locY > 0; --locY)
		{
			;
		}
		...
		if (soil == null || !soil.canSustainPlant(worldIn, pos, EnumFacing.UP, GenesisBlocks.trees.getBlock(TreeBlocksAndItems.SAPLING, EnumTree.LEPIDODENDRON)))
		{
			return false;
		}
